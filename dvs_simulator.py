...
INPUTS_DIR = Path("outputs")
OUUTPUTS_DIR = Path("inputs")
INPUT_VIDEO = INPUTS_DIR / "a1_old.mov"
OUTPUT_VIDEO = OUUTPUTS_DIR / "dvs_output.mov"
...
class DVSSimulator:
    ...
    def process(self):
        ...
        out = cv2.VideoWriter(str(self.output_path), fourcc, fps, (width, height), isColor=False)
